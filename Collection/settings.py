...
SECRET_KEY = 'django-insecure-fkija72)r4#j^pdcfm8=f4b6wmfleywr-r_oe)c%nu&@rbm09d'
...
if DEBUG:
    ...
    ALLOWED_HOSTS = ['darkov666.pythonanywhere.com']
...
TAILWIND_APP_NAME = 'collection_app'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "collection_app" / "static"]
#STATICFILES_DIRS = [
#    BASE_DIR / "static",
 #   ]
